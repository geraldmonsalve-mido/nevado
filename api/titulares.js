...
export default async function handler(req, res) {
  ...
  if (method === 'GET') {
    ...
    try {
      ...
      let query = supabase
        .from('titulares_envios')
        .select('id,titulo,categoria,autor_nombre,autor_username,autor_rank,estado,ia_score,created_at,updated_at,profile_id,seccion,resumen,cuerpo,fuentes,imagen_url,publicado_en,nota_editorial')
